...
def create_model(args, feature_map):
    ...
    node_embedding_layer = nn.Embedding(len_node_vec+2, len_node_vec, max_norm=True).to(device=args.device)
    edge_embedding_layer = nn.Embedding(len_edge_vec+2, len_edge_vec, max_norm=True).to(device=args.device)
    ...
    model = {
        ...
        'node_embedding_layer': node_embedding_layer,
        'edge_embedding_layer':edge_embedding_layer
    }
