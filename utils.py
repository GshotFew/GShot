...
def save_model(epoch, args, model, optimizer=None, scheduler=None,fine_tuned_name=None, **extra_args):
    ...
    print("saving ", fname)
    print('fine fine_tuned_name ', fine_tuned_name)
    if(fine_tuned_name is not None ):
        fname = fname + fine_tuned_name
