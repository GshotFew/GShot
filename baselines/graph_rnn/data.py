...
class Graph_Adj_Matrix_from_file(Dataset):
    ...
    def __init__(self, dict_dataset_current, graph_list, feature_map, random_bfs=False):
        ...
        self.max_prev_node = dict_dataset_current['max_prev_node']
        # Head and tail of adjacency vector to consider for edge prediction
        # self.max_head_and_tail = args.max_head_and_tail
        self.max_head_and_tail = dict_dataset_current['max_head_and_tail']
