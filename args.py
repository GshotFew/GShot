...
class Args:
    ...
    def __init__(self):
        ...
        # self.graph_type = 'META-YEAST-LUNG-BREAST-Leukemia-MODEL'
        # self.graph_type = 'META-YEAST-LUNG-BREAST-AIDS-ca-MODEL'
        self.graph_type = 'META-YEAST-LUNG-BREAST-MUTAG-MODEL'
        # self.graph_type = 'Leukemia'
        # self.graph_type = 'charged_n_balls_meta346'
        # self.graph_type = 'charged_n_balls_-meta345-5000'
        # self.graph_type = 'spring_n_balls_-meta6'
        # self.graph_type = 'charged_n_balls_6'
        # self.graph_type = 'charged_n_balls_5_single'
        # self.graph_type = 'spring_n_balls_5'
        # self.graph_type = 'spring_n_balls_5-meta346'
        # self.graph_type = 'spring_n_balls_5_single'
        # self.graph_type = 'spring_n_balls_metanew-fixed'
        # self.graph_type = 'spring_n_balls_5_single'
        # self.graph_type = 'AIDS-ca'
        # self.graph_type = 'spring_n_balls-meta-346'
        # self.graph_type = 'spring_n_balls-3-4-6-Meta'
        # self.graph_type = 'charged_n_balls_META346-15-15fix'
        ...
        self.load_model_path = ''
        self.load_device = torch.device('cuda:3')
        # self.epochs_end = 10000
        self.epochs_end = 25000
